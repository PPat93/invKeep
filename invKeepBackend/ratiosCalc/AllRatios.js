...
module.exports = class AllRatios {
    ...
    analyzeData(detailedRatiosArray) {
        return new CAPERatio((sharedJS.searchObject(detailedRatiosArray, sharedJS.RatiosNames.cape_ratio)).valueNum).returnAlldata();
        // return analyzedArray =this.objCAPERatio.returnAlldata()
            // [
